...
public class CStruct_Desk02 extends CAbstruct_Desk {
	public CStruct_Desk02(World world) {
	...
	public void initCells() {
		...
		cells[1][2] = new ConstructionSprite("cstructp_desk001");
		
		//Set correct animations
		cells[0][0].current("A_r2c1");
		...
		outlinePoly.addPoint((float) (World.convertToEntityPixels(3 * tw)), (float) (World.convertToEntityPixels(2 * th)));
		outlinePoly.addPoint((float) (World.convertToEntityPixels(1 * tw)), (float) (World.convertToEntityPixels(2 * th)));
		outlinePoly.addPoint((float) (World.convertToEntityPixels(1 * tw)), (float) (World.convertToEntityPixels(1 * th)));
